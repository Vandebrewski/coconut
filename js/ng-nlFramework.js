  ...
  var nlRefresh = {
    init: function(){
      ...
      // get references to elements
        ...
        $nlElements.refIcon.style.transition = 'all '+(0)+'s '+$nlConfig.options.animation;
      // set initial values
      ...
      if ( !$nlConfig.syncing ){
        //if ( $nlConfig.scroll.top < 1 ){
          ...
          if ( ev.center.y < end ){
            ...
            $nlElements.refIcon.style.transition = 'fill '+0*4+'s '+$nlConfig.options.animation;
    ...
    touchEnd: function( element ){
      ...
      var onEnd = function(e, touch){
        ...
        setTimeout( function(){
          $nlElements.refEl.style.transition = 'all '+(0/2)+'s '+$nlConfig.options.animation;
          if ( touchobj.clientY > end && $nlConfig.syncTrue && !$nlConfig.syncing){
            ...
            setTimeout( function(){
              $nlElements.refEl.style.transition = 'all '+(0/2)+'s linear';
            ...
            $nlElements.refEl.style.transition = 'all '+(0)+'s '+$nlConfig.options.animation;
